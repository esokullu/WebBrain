/**
 * Official MiniCPM5-1B chat template.
 *
 * Bundled because Transformers.js 4.2 does not attach a repository's
 * standalone chat_template.jinja to a plain PreTrainedTokenizerFast.
 * Source: https://huggingface.co/alexHSM/MiniCPM5-1B-ONNX-Web/blob/c865cff13c46c7abaf4472f35e67ef809746cb11/chat_template.jinja
 * Upstream license: Apache-2.0.
 */
export const MINICPM5_CHAT_TEMPLATE = String.raw`{{- bos_token }}{%- if tools %}
